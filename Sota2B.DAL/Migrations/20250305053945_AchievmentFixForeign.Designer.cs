...
namespace Sota2B.DAL.Migrations
{
    ...
    [Migration("20250305053945_AchievmentFixForeign")]
    partial class AchievmentFixForeign
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sota2B.DM.Models.Achievment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Sota2B.DM.Models.UserHasAchievment", b =>
                {
                    b.Property<int>("IdUser")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Sota2B.DM.Models.Achievment", b =>
                {
                    b.HasOne("Sota2B.DM.Models.Event", "Event")
                        .WithOne("Achievment")
                        .HasForeignKey("Sota2B.DM.Models.Achievment", "IdEvent")
            ...
            modelBuilder.Entity("Sota2B.DM.Models.UserHasAchievment", b =>
                {
                    b.HasOne("Sota2B.DM.Models.Achievment", "Achievment")
